...
def cadastro():
    if verifica_sessao():
        ...
        filename=id_foto+nome_prod+'.jfif'
        img_prod.save("static/img/"+filename)
        conexao = conecta_database()
...
#FINAL DO CODIGO - EXECUTANDO O SERVIDO r
app.run(debug=True)